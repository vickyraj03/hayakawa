...
class DecoratedContainer extends StatelessWidget {
  const DecoratedContainer({
    ...
    this.padding,
    this.alignment,
    this.clipFCorner=false, this.decoration,
  ...
  Widget build(BuildContext context) {
    ...
    BoxDecoration dec = BoxDecoration(
      ...
      tabDecoration?Shadows.tabShadow:Shadows.universal,
    );
    // Create decoration
    BoxDecoration _cornerOnly = BoxDecoration(
      color: color,
      border: border,
      borderRadius: const BorderRadius.only(topLeft: Corners.medRadius,topRight: Corners.medRadius),
    ...
    return Container(
      decoration: innerDecoration? _insha: imgDecoration? _img:decorationGradient?_decorationGradient:clipFCorner?dec:cardDecoration?_cardDecoration:_cornerOnly,
      width: width,
      height: height,
      padding: padding,
      alignment: alignment,
...
class Shadows {
  static List<BoxShadow> get universal => [
    BoxShadow( color:  Colors.grey.withOpacity(0.4),blurRadius: 4,spreadRadius: 0.0,offset: const Offset(0,0))

  ];
  static List<BoxShadow> get calenderArrow => [
    BoxShadow( color:  Colors.grey.withOpacity(0.4),blurRadius: 4,spreadRadius: 6,offset: const Offset(0,0))

  ];

  static List<BoxShadow> get button => [
    BoxShadow( color: AppColors.kPrimaryColor,blurRadius: 4,spreadRadius: 0.0,offset: const Offset(0,0))

  ];


  static List<BoxShadow> get tabShadow => [
    BoxShadow( color:  Colors.red,blurRadius: 0.5,spreadRadius: 0.0,offset: const Offset(0,0))
  ];
...
class Corners {
  ...
  static const BorderRadius smBorder = BorderRadius.only(topRight: smRadius,topLeft: smRadius);
  static const Radius smRadius = Radius.circular(sm);

  static const double med = 10.0;
  static const BorderRadius medBorder = BorderRadius.only(
      topRight: medRadius,topLeft: medRadius
  );
  static const Radius medRadius = Radius.circular(med);

  static const double lg = 15.0;
  static const BorderRadius lgBorder = BorderRadius.only(
      topRight: lgRadius,topLeft: lgRadius
  );
