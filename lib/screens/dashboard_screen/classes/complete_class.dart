        ...
        builder: (context, state) {
          ...
          if (state is CompleteClassLoaded) {
            if (state.completeClass.result == "error") {
              ...
              // });
              return Center(
                child: textStyle(text: state.completeClass.data1.toString()),
              );
              ...
              if (_completeclass!.isNotEmpty) {
                ...
                return Center(
                    child: textStyle(
                        text: 'Sorry, you don’t have any completed batch!'));
              }
            }
          }
  ...
  Widget _completeClassUI() {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return _completeclass != null || _completeclass!.isEmpty
            ? Padding(
            ...
            : Center(
                child: Padding(
                  ...
                  child: textStyle(
                      text: 'No Complete Class', style: TextStyles.h2),
                ),
              );
      },
    );
