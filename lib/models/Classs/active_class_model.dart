class ActiveClass {
  String? result;
  String? message;
  List<ActiveClassResult>? data;
  String? data1;

  ActiveClass({this.result, this.message, this.data});

  ActiveClass.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    message = json['message'];
    if (json['data'] != "Batch is not available") {
      data = <ActiveClassResult>[];
      json['data'].forEach((v) {
        data!.add( ActiveClassResult.fromJson(v));
      });
    }else{
      data1 = json['data'];
    }
...
class ActiveClassResult {
  ...
  ActiveClassResult.fromJson(Map<String, dynamic> json) {
...
class CourseHistory {
  ...
  CourseHistory({this.crhId, this.courseId, this.batchId, this.refId});
